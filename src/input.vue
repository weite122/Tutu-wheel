<template>
    <div :class="{error}" class="wrapper">
        <input :disabled="disabled" :readonly="readonly" :value="value" @blur="$emit('blur', $event)" @change="$emit('change', $event)"
...
<style lang="scss" scoped>
    ...
    $red: #F1453D;
    .wrapper {display: inline-flex; align-items: center;font-size: $font-size;
